...
import InvoiceListTable from "./transactions-table"
  ...
  return (
    <Fragment>
      <Breadcrumbs>
        ...
        <BreadcrumbItem>Transacciones</BreadcrumbItem>
      </Breadcrumbs>
      <Card className="mt-6">
        <CardHeader className="flex-row items-center border-none mb-0">
          <CardTitle className="flex-1 text-xl font-medium text-default-900">Administrar Transacciones</CardTitle>
          <Button
